...
public class PlanActivityAdapter extends ArrayAdapter<Activity> {
    ...
    public PlanActivityAdapter(Context ctx, int textViewResourceId, int id, List<Activity> objects, int current, OnTimerClickInterface controller ) {
    ...
    public static boolean cancelPotentialWork(String path, ImageView imageView) {
        ...
        if (bitmapWorkerTask != null) {
            ...
            if (bitmapData == null || bitmapData.equals("") || !bitmapData.equals(path)) {
        ...
        if (activity != null) {
            ...
            if (activityTimer != null){
                if(activity.getSlides().size()>0){
                    activityTimer.setImageResource(R.drawable.ksiazki);
                    activityTimer.setVisibility(View.VISIBLE);
                    activityTimerLabel.setVisibility(View.INVISIBLE);
                } else {
                    activityTimer.setImageResource(R.drawable.timer);
                    activityTimerLabel.setText("");
                    if(activity.getTime()==0 || activity.getStatus().equals(Activity.ActivityStatus.FINISHED.toString())){
                        activityTimerLabel.setText("");
                        activityTimerLabel.setVisibility(View.INVISIBLE);
